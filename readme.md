...
The scripts provided use the sequenceCondenser on entire sequences.  Alternately, condenser can be restricted to specific regions or joined combinations of discontinuous regions, which will result in different cluster assignments.
